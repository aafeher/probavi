// Command probavi-adapter-postgres is the PostgreSQL engine adapter for
// Probavi, implementing probavi-adapter/0 (docs/adapter-protocol.md).
//
// It is deliberately self-contained: standard library only, no imports
// from the Probavi core — an adapter must be writable from the protocol
// document alone, and this one proves it.
package main
